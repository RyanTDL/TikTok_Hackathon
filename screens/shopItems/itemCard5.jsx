...
export default function ItemCard5({navigation, price, name}) {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.productImage}>
                <Image 
                    ...
                    source={require('../../assets/gifts/camera.png')} 
                />
            </View>
            ...
            <View style={styles.itemDescriptor}>
                ...
                <Text style={{fontSize: 20, fontWeight: '600'}}>Canon EOS 400D</Text>
                <Text style={{fontSize: 20, fontWeight: '600'}}>$620</Text>
