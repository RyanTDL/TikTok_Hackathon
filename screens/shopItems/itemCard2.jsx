...
export default function ItemCard2({navigation, price, name}) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.productImage}>
                <Image 
                    ...
                    source={require('../../assets/gifts/guitar.png')} 
                />
            </View>
            ...
            <View style={styles.itemDescriptor}>
                ...
                <Text style={{fontSize: 20, fontWeight: '600'}}>Electric Guitar</Text>
                <Text style={{fontSize: 20, fontWeight: '600'}}>$325</Text>
