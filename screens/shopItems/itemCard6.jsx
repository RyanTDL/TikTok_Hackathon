...
export default function ItemCard6({navigation, price, name}) {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.itemDescriptor}>
                ...
                <Text style={{fontSize: 20, fontWeight: '600'}}>Lenovo Laptop</Text>
                <Text style={{fontSize: 20, fontWeight: '600'}}>$2,650</Text>
